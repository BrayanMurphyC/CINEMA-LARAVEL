...
class Admin{
    ...
    public function handle($request, Closure $next)
    {
      ...
      if ($this->auth->user()->id != 15) {  //ACCEDEMOS AL USUARIO Y SU ID SI NO ES SU ID = 1 NO ES EL ADMINISTRADOR ENTONCES LE ENVIAMOS UN MENSAJE ERROR DICIENDO QUE NO TIENE  PRIVILEGIOS
